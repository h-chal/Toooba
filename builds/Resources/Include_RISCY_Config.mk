...
BSC_COMPILATION_FLAGS += \
	...
	-D ALTERNATE_IFC_NAP \
	-D ALTERNATE_IFC_NAP_PTGS \
	-D ALTERNATE_IFC_BDP \
	-D ALTERNATE_IFC_BDP_PTGS


# ALTERNATE_IFC_NAP enables an alternate NextAddrPred interface.
#	Then ALTERNATE_IFC_NAP_GSELECT or ALTERNATE_IFC_NAP_PARAM must be defined to determine which predictor for the interface.
# ALTERNATE_IFC_BDP enables and alternate DirPred interface.
#	Then ALTERNATE_IFC_BDP_GSELECT or ALTERNATE_IFC_BDP_PARAM must be defined to determine which predictor for the interface.
